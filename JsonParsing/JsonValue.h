...
public:
    ...
    using ObjectType = vector<pair<string, JsonValue>>;
...
private:
    Type type_;
    variant<monostate, bool, double, string, ArrayType, ObjectType> value_;
};

class JsonTypeException : public runtime_error
{
public:
    explicit JsonTypeException(const string& message) : runtime_error(message) {}
};
